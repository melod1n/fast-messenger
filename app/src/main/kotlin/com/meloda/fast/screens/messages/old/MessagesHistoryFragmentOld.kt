package com.meloda.fast.screens.messages.old
...
import com.meloda.fast.screens.messages.MessagesDeleteEvent
import com.meloda.fast.screens.messages.MessagesEditEvent
...
import com.meloda.fast.screens.messages.MessagesLoadedEvent
import com.meloda.fast.screens.messages.MessagesMarkAsImportantEvent
import com.meloda.fast.screens.messages.MessagesNewEvent
import com.meloda.fast.screens.messages.MessagesReadEvent
        ...
        binding.recyclerView.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                if (AppGlobal.preferences.getBoolean(
                        SettingsKeys.KEY_FEATURES_HIDE_KEYBOARD_ON_SCROLL,
                        true
                    ) && dy < 0
                ) {
                ...
                adapter.getOrNull(firstPosition)?.let {
                    ...
                    val showExactTime = AppGlobal.preferences.getBoolean(
                        SettingsKeys.KEY_SHOW_EXACT_TIME_ON_TIME_STAMP,
                        false
                    )
